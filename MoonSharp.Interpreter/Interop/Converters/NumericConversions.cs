...
namespace MoonSharp.Interpreter.Interop.Converters
{
    ...
    internal static class NumericConversions
    {
        ...
        /// </summary>
        internal static object FixedNumberToType(Type type, FixedNumber d)
        {
        ...
        /// </summary>
        internal static FixedNumber TypeToFixedNumber(Type type, object d)
        {
            if (type == typeof(FixedNumber)) {
                return (FixedNumber)d;
            }
